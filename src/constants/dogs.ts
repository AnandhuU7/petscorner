...
for kids and adults alike. to differentiate between a male and female Shiba Inu, as they have distinct physical and emotional qualities. For starters, males stand up to 16.5 inches tall and weigh about 23 pounds. Females are smaller, standing around 13.5 inches tall and weighing 17 pounds. A male Shiba will have a broader face, while the female has softer facial features. No matter the gender, the Shiba Inu is built like a hunter-quick and agile, with a confident stance. Their perky, triangular ears and fluffy curlicue tail give them the look of a forest animal from a storybook.`,
        breedHighlights: `Being small, compact, and robust, Beagles are active companions  for kids and adults alike. `,
        weight: {
            from: 10,
            to: 11,
        },
    ...
    },
    {
        ...
        breedAppearance: `An elegant, observant, swift-moving, compact little dog with saucy expression, and with terrier-like qualities of temperament.`,
        breedHighlights: `The Chihuahua is a tiny toy-sized dog. The height of the dog is less than its length. The head is well-rounded, apple-shaped, and the muzzle is short and pointed with a well-defined stop. `,
        weight: {
            from: 1.8,
            to: 2.7
        },
        ...
        pros: [`Chihuahuas are adorable. Chihuahuas are suitable pets for apartment living. Chihuahuas are proficient watch dogs. Chihuahuas can be trained to use a litterbox indoors.Chihuahuas are straightforward to groom.`
        ],
        cons: [`Chihuahuas can be fragile. Some Chihuahuas are not recommended for young children.Chihuahuas are averse to freezing environments.Some Chihuahuas are not family dogs.Some Chihuahuas may tend to bark a lot.`
        ],
        imageURL: `https://cdn.shopify.com/s/files/1/1199/8502/files/28_2048x2048.jpg?10059043838510730134`
...
},
{
    ...
    litterSize: 6,
    history:`Breed by the royal families of Chippiparai near Madurai district in Tamil Nadu, India, the Chippiparai was and continues to carry on the legacy of regality and nobility left by many Tirunelveli and Madurai rulers. Chippiparais are known to be aggressive hunters and were bred for this specific purpose. They were predominantly used to find and kill their prey, mainly deer, wild boar, and hare.`,
    originally: `The Chippiparai is a sight hound breed of dog from the south of India. Thought to be a descendant of the Saluki, today it is found in areas around Periyar Lake. Chippiparai was chiefly pressed into service for hunting and supervising farms. Just some years ago, most of the farm people treated this breed as a watch-dog. Since it has a long and thin leg, it can move more swiftly and blisteringly than any other breed.`,
    currentlyUsedAs: `Watch dogs, Huntings dogs`,
    training: `Training Chippiparais is much easier when compared to the other hounds, owing to their enormous intelligence and desire to appease the owners. They cannot survive without enough physical activities and exercises every day. They will devote their energy needlessly towards trivial things, if their minds and bodies are not exercised enough.   `,
    healthCare: `Generally the breed is healthy. Though sturdy enough to withstand adverse climatic conditions with limited means, the breed is resistant to cold weather. They are also  plagued by certain general health issues, such as sensitivity to anesthesia and food allergies. `,
    livingCondition: `Generally outdoor dogs as they are used as hunting dogs.`,
    excersie: `These dogs require daily walks and running.`,
    grooming: `Chippiparais have short coats and do not require much grooming. You can brush them once or twice a week. Like most breeds, they love being massaged, so they will never complain about being brushed with a soft brush or a hound mitt.`,
    pros: [`Ideal for Indian weather`, 
            `Perfect guard dog and watchdog for the family`,
            `Easy to groom.`
    ],
    cons: [`Needs regular exercise`,
            `Not comfortable with small children and smaller pets`,
            `Can attach themselves to one person and be suspicious of everyone else`
    ],
    imageURL:`https://cdn.shopify.com/s/files/1/1199/8502/files/CHippiParai_2048x2048.jpg?5379189132046520260`
...
},
{
    ...
    litterSize: 9,
    history:`The breed had been developed and cultivated chiefly in England. The first unofficial standard for the breed was introduced by an Englishman Vero Shaw in 1882. In 1890, with the formation of the first Dalmatian Club in England, the standard became official. When the dog with the distinctive markings was first shown in England in 1862, it was said to have been used as a guard dog and companion to the nomads of Dalmatia. The popularity of the breed's unique coat spread like wildfire so much that it was distributed to virtually each and every nook and corner of the European continent in 1920 and onwards. Its unusual markings were often mentioned by the old writers on cynology.`,
    originally: `A dense cloud of mystery has engulfed the subject of the origin of this breed. Spotted dogs are known throughout history in Africa, Europe and Asia. The breed may be related to the Pointer. Traces of spotted dogs are found in Egyptian bas-reliefs and Hellenic friezes, so it is certainly a primitive breed. In 1700, a dog known as the Bengal pointer, similar to the Dalmatian, prevailed in England, calling into question the Dalmatian’s Yugoslavian origin. Some argue that the Dalmatian is a Croatian breed. `,
    currentlyUsedAs: `Movie dogs, Guard dogs also`,
    training: `Training Dalmatians is all about rewarding decent conduct and eliminating unceremonious habits. The Dalmatian breed is very intelligent and that sometimes can make training easier said than done. The key to fruitful and prompt training outcomes is being confident, consistent and devoted throughout the span of each training session.`,
    healthCare: `This breed is notorious for alarmingly high deafness levels; about 10-12% are born deaf. Dalmatian puppies should be BAER-tested for deafness at about 6 weeks old, and totally deaf puppies should be spayed or neutered. While the breeding of deaf puppies should be avoided, it is very possible to raise a well-adjusted deaf dog. They can be prone to urinary stones, as uric acid levels in Dalmatians are, in general, higher than in any other breed, sometimes trigerring urinary blockage. They can also fall prey to skin allergies, such as synthetic fibers in carpets and upholstery.`,
    livingCondition: `A Dalmatian is not an ideal dog for apartment dwellers unless it can be taken out for a brisk walk or run several times a day. They are very active indoors and will do best with at least an average-sized yard. Not suited to living outside in cold climates.`,
    excersie: `A Dalmatian is not an ideal dog for apartment dwellers unless it can be taken out for a brisk walk or run several times a day. They are very active indoors and will do best with at least an average-sized yard. Not suited to living outside in cold climates.`,
    grooming: `The Dalmatian sheds all year round but does copiously only twice a year. Brush frequently to help manage the constant shedding. They do not have a doggy odor and are said to be clean and even avoid puddles. Bathe only when necessary.`,
    pros: [`Merrymaking, zealous! Lively, active! Ideal family dog Intelligent, obeisant, quick to learn People-oriented, fabulous house dog and a reliable companion for all sorts of indoor and outdoor environments. Natural affinity for horses, adores hiking, jogging, biking and rollerblading with owner.`
    ],
    ...
    imageURL:`https://cdn.shopify.com/s/files/1/1199/8502/files/14_large.jpg?12248259238347982599`
